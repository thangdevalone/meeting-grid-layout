...
| `floatSize`          | `FloatSize`                               | `'medium'`  | Responsive size for auto-float PiP: `'small' \| 'medium' \| 'large'` |
...
| `aspectRatio`     | `string`                                                      | `'16:9'`                         | Aspect ratio of the floating PiP item            |
...
<GridContainer count={2} floatSize="large">
